...
// const BASE_URL = "https://reserve.nic.in/ReserveAPI/API";
...
//   return useQuery<Vc[]>({
//     queryKey: ["external-vcs"],
//     queryFn: () => fetchApi<Vc[]>("/vcs"), // adjust endpoint if needed
...
//     queryFn: () => fetchApi<DashboardStats>("/stats"), // adjust endpoint
//     refetchInterval: 30000,
//   });
// }
